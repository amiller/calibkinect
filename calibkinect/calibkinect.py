...
def projection():
    """
    Camera matrix for aligned projections
    """
    fx = 528.0
    fy = 528.0
    cx = 320.0
...
def convertOpenNI2Real_numpy(depth, u=None, v=None,
    ...
    """
    Convert an OpenNI depth image to 3D euclidean values (XYZ)
    (Numpy version)
    Args:
        depth: an OpenNI depth image shape=(480,640), dtype='u2'
    Returns:
        X,Y,Z: numpy matrices shape=(480,640), dtype='f'
    """
    if u is None or v is None: v,u = full_vu
